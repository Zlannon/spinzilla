...
import com.team233.math.CircularFilter;
import com.team233.math.MathHelpers;
import com.team233.mechanisms.PowerManaged;
import com.team233.swerve.DriveSource;
import com.team233.swerve.DriveSourceType;
import com.team233.swerve.SwerveAssist;
import com.team233.swerve.TrailblazerDriveSource;
import com.team233.swerve.XboxControllerDriveSource;
...
public class Swerve extends StateMachineSubsystem<SwerveState> implements PowerManaged {
  ...
  public void applyCurrentLimits(double supplyCurrentLimit) {
    ...
    drivetrain
        ...
        .getConfigurator()
        .apply(
            TunerConstants.FrontRight.DriveMotorInitialConfigs.CurrentLimits
                    .withSupplyCurrentLimit(supplyCurrentLimit));
    drivetrain
        .getModule(2)
        .getDriveMotor()
        .getConfigurator()
        .apply(
            TunerConstants.BackLeft.DriveMotorInitialConfigs.CurrentLimits
                    .withSupplyCurrentLimit(supplyCurrentLimit));
    ...
    drivetrain
        ...
        .getConfigurator()
        .apply(
            TunerConstants.BackRight.DriveMotorInitialConfigs.CurrentLimits
                    .withSupplyCurrentLimit(supplyCurrentLimit));
  }
}